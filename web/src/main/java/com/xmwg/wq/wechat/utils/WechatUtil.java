...
import com.xmwg.wq.wechat.model.Menu;
...
//    private RestTemplate restTemplate;
    ...
    public static AccessToken getAccessToken(String appid, String appsecret) {
        log.info("weixin api appid:{}，appsecret:{}", appid,appsecret);
        AccessToken accessToken = null;
        String requestUrl = access_token_url.replace("APPID", appid).replace("APPSECRET", appsecret);
        //https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=wxdd5a342d67dc86d8&secret=789f3bb99cfaeae4adb147b33cadad5a
